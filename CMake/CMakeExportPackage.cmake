...
function(CMAKE_EXPORT_PACKAGE)
	set(BOOLEAN NO_SET_AND_CHECK_MACRO NO_CHECK_REQUIRED_COMPONENTS_MACRO)
	set(SINGLE INPUT_FILE OUTPUT_FILE INSTALL_DESTINATION INSTALL_PREFIX VERSION_FILE VERSION COMPATIBILITY)
	set(MULTI PATH_VARS)

	cmake_parse_arguments(PKG "${BOOLEAN}" "${SINGLE}" "${MULTI}" ${ARGN})
	...
	if(NOT IS_ABSOLUTE "${PKG_INPUT_FILE}")
		get_filename_component(PKG_INPUT_FILE "${PKG_INPUT_FILE}" ABSOLUTE)
	endif()
